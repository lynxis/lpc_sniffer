...
NAME=top
DEPS=buffer.v lpc.v mem2serial.v ringbuffer.v uart_tx.v power_on_reset.v trigger_led.v
...
top_tb.vpp: top_tb.v top.v buffer.v lpc.v mem2serial.v ringbuffer.v uart_tx.v power_on_reset.v trigger_led.v
	iverilog -o top_tb.vpp top_tb.v top.v buffer.v lpc.v mem2serial.v ringbuffer.v uart_tx.v power_on_reset.v trigger_led.v
